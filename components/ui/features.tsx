                ...
                >
                  ...
                  >
                    ...
                    <div
                      ...
                      ${
                        isActive
                          ...
                          : `${primaryColor}/10 dark:bg-black/80 text-sky-500`
                      }
                    `}
                    >
                      <Icon size={24} />
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-4 bg-gray-200 dark:bg-black/80 rounded-sm h-1 overflow-hidden">
                        {isActive && (
                          <motion.div
                            className={progressGradientLight}
                            initial={{ width: 0 }}
